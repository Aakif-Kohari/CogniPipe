...
| `baseUrl`         | `string` (URL)                | —        | `https://api.openai.com/v1` | Override for Azure OpenAI, OpenRouter, etc. **Must be `https://`** to prevent sending the API key in cleartext. Insecure local gateways are not supported in v1.                                                                                                                                                  |
